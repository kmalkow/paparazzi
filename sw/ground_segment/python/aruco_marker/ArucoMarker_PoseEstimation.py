...
#  ------------------------------------------------------------------------- #
pathLoad = '/home/kevin/paparazzi/sw/ground_segment/python/aruco_marker/camera_parameters/MAPIR_cameraCalibration_Video_w1920_h1080_HERELINKV2.xml' # Calibrated for video streaming with resolution w=1920, h=1080
...
out = cv2.VideoWriter('/home/kevin/paparazzi/sw/ground_segment/python/aruco_marker/video_recordings/Test1.mp4', fourcc, FPS, (frame_width, frame_height))
...
#                          SAVE MEASURED VARIABLES                           #
#  ------------------------------------------------------------------------- #
# with open('/home/kevin/paparazzi/sw/ground_segment/python/aruco_marker/measurement_results/INDOOR_TEST_X_V2', 'w') as csvfile:
#     writer=csv.writer(csvfile, delimiter=',')
#     writer.writerows(zip(X_m, time_m))

# with open('/home/kevin/paparazzi/sw/ground_segment/python/aruco_marker/measurement_results/INDOOR_TEST_Y_V2', 'w') as csvfile:
#     writer=csv.writer(csvfile, delimiter=',')
#     writer.writerows(zip(Y_m, time_m))

# with open('/home/kevin/paparazzi/sw/ground_segment/python/aruco_marker/measurement_results/INDOOR_TEST_Z_V2', 'w') as csvfile:
#     writer=csv.writer(csvfile, delimiter=',')
#     writer.writerows(zip(Z_m, time_m))

# with open('/home/kevin/paparazzi/sw/ground_segment/python/aruco_marker/measurement_results/INDOOR_TEST_Dist_V2', 'w') as csvfile:
#     writer=csv.writer(csvfile, delimiter=',')
#     writer.writerows(zip(EuclideanDistance_m, time_m))
